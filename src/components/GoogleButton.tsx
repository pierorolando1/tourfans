...
export const GoogleButton = ({ onClick } : { onClick: any }) => {
    return (
        <button onClick={onClick} type="button" className="transition-all w-full block bg-white hover:bg-gray-100 focus:bg-gray-200 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
